    ...
    <>
      {!Login ? (
        ...
        <nav className="">
          ...
          >
            <div style={{ display: "flex", flexDirection: "row" }}>
              <Link className=" navlink loggedin" to="/">
                Home{" "}
              </Link>
              <Link className=" navlink loggedin" to="/Profile">
                Profile{" "}
              </Link>

              {/* <Link className=" navlink loggedin" to="/Profile">Analytics </Link> */}

              <Link className=" navlink loggedin" to="/Resources">
                Resources{" "}
              </Link>
              <Link className=" navlink loggedin" to="/Analytics">
                Analytics{" "}
              </Link>
